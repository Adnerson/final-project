...
class UserScreenState extends State<UserScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return profileScreen(user, userProvider, context, args);
  }

  Scaffold profileScreen(User? user, UserProvider userProvider,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              args.phoneNumber ?? 'Unknown',
              style: const TextStyle(fontSize: 16),
            ),
            const SizedBox(height: 16),
            // medicationText(),
            // medicationBox(user, userProvider),
            // medicationAdd(context, userProvider),
            // editAccount(context, userProvider),
  ...
  ElevatedButton logOut(UserProvider userProvider, BuildContext context) {
  ...
  ElevatedButton editAccount(BuildContext context, UserProvider userProvider) {
    return ElevatedButton(
      onPressed: () {
  ...
  Container medicationBox(User? user, UserProvider userProvider) {
    return Container(
      height: 200,
  ...
  void _showNewMedicationDialog(
      BuildContext context, Function(Medication) addMedication) {
    showDialog(
      context: context,
      builder: (context) {
